...
def compare_effective_dims(graph_title, titles, models, X_test, y_test, vocab_size):
...
def make_frame(fps, model_titles, X_test, y_test, vocab_size):
    def make_real_frame(t):
        ...
        return compare_effective_dims(graph_title, model_titles, models, X_test, y_test, vocab_size)
...
def create_video(video_title, model_titles):
    ...
    animation = VideoClip(make_frame(fps, model_titles, X_test, y_test, vocab_size), duration = duration)
